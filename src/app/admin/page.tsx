...
export default function AdminDashboard() {
  ...
  const navigationItems = [
    ...
    { id: "categories" as TabType, label: "Categories", icon: CategoryIcon },
    { id: "products" as TabType, label: "Products", icon: ProductIcon },
    { id: "reviews" as TabType, label: "Reviews", icon: ReviewIcon },
    { id: "orders" as TabType, label: "Orders", icon: OrdersIcon },
  ];
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "categories":
        return <Categories isDarkTheme={isDarkTheme} />;
